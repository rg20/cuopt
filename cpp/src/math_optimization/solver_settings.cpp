...
solver_settings_t<i_t, f_t>::solver_settings_t() : pdlp_settings(), mip_settings()
{
  ...
  int_parameters = {
    ...
    {CUOPT_DUAL_SIMPLEX_PRICING, &pdlp_settings.dual_simplex_pricing, CUOPT_DUAL_SIMPLEX_PRICING_AUTOMATIC, CUOPT_DUAL_SIMPLEX_PRICING_QUADRATIC_STEEPEST_EDGE, CUOPT_DUAL_SIMPLEX_PRICING_STEEPEST_EDGE},
