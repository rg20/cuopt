...
solver_settings_t<i_t, f_t>::solver_settings_t() : pdlp_settings(), mip_settings()
{
  ...
  int_parameters = {
    ...
    {CUOPT_DUAL_SIMPLEX_PRICING, reinterpret_cast<int*>(&pdlp_settings.dual_simplex_pricing), CUOPT_DUAL_SIMPLEX_PRICING_STEEPEST_EDGE, CUOPT_DUAL_SIMPLEX_PRICING_QUADRATIC_STEEPEST_EDGE, CUOPT_DUAL_SIMPLEX_PRICING_STEEPEST_EDGE, "Dual simplex pricing: 0 exact steepest-edge (default), 1 quadratic steepest-edge"},
